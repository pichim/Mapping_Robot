...
from typing import Any, List, MutableSequence, Protocol, Sequence, cast
...
def calculate_crc8(buffer: Sequence[int]) -> int:
...
def verify_checksum_seq(seq: Sequence[int]) -> bool:
...
def load_tx_frame(tx_list: MutableSequence[float], frame_idx: int) -> None:
    """
...
# Initialize SPI (use getattr to avoid Pylance complaining about unknown member types)
